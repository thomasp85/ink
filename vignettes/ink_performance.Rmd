---
title: "Ink Performance"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ink Performance}
...
res <- bench::mark(
  ink = {ink_bmp(file); plot.new(); dev.off()},
...
all_render_bench <- function(expr, xlib = TRUE) {
  ...
  res <- list(
    render_bench(ink_bmp(file), ink = !!expr),
  ...
  res$Anti_aliased <- c(TRUE, TRUE, FALSE, TRUE, TRUE, FALSE)[seq_len(nrow(res))]
  res
}
